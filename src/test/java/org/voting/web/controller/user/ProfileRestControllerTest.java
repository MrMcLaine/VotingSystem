...
import static org.voting.web.controller.user.ProfileRestController.REST_URL;
...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userService.getAll(), ADMIN, JAMES, DAVID);
    }

    @Test
    void update() throws Exception {
        User updated = new User(USER_ID, "UpdatedUser", "user@gmail.com", "password", Role.USER);
